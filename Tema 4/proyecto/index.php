    ...
    <header class="header">
        ...
        <nav class="header__nav">
            <ul class="header__nav-list">
                <li class="header__nav-item"><a class="header__nav-link" href="">Enlace innecesario</a></li>
                <li class="header__nav-item"><a class="header__nav-link" href="">Enlace innecesario</a></li>
                <li class="header__nav-item"><a class="header__nav-link" href="">Enlace innecesario</a></li>
            </ul>
        </nav>
    ...
    <main class="main">
        <form class="form" action="" method="post">
            ...
            <fieldset class="form__fieldset">
                ...
                <label class="form__label">
                    Teléfono:
                    <input class="form__input" type="number" name="telephone" value="" placeholder="Tu puto número para saber a quién llamar a la hora que más te joda">
                </label>
            </fieldset>
